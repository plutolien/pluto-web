    ...
    <div className="w-full py-20 flex items-center justify-end">
      <div className="container flex lg:flex-row flex-col lg:space-x-24">
        <div className="relative">
          ...
          <div
            className="absolute left-0 right-0 top-0 bottom-0 flex h-full w-full flex-col items-center justify-center space-y-8">
            <div className="relative bg-white rounded-xl px-6 py-6 w-27rem ml-24 shadow-sm">
              <div className="flex flex-row space-x-4">
                <Image className="w-16 h-16 rounded-full" src={heroImage} alt="hero-image" />
              </div>
      ...
      <div className="flex flex-col text-left py-12 px-6">
        ...
        <p className="mt-8 text-lg text-gray-700">There are a lot of clients testimonials on my Upwork profile. I just
          added a few of them here.</p>
        <div className="mt-8 flex">
          <a
            className="items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-[#0B132A] hover:bg-[#122040] md:py-4 md:text-lg md:px-10">
            Explore More
          </a>
        </div>
      </div>
