        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full px-4">
            <div className="flex flex-wrap justify-center items-center">
              ...
              >
                <Image src={B1} alt="hero-image" className="w-full h-10" />
              </a>
              <a
                href="#"
                className="w-[150px] 2xl:w-[180px] py-5 flex items-center justify-center mx-4"
              >
                <Image src={B2} alt="hero-image" className="w-full h-10" />
              </a>
              <a
                href="#"
                className="w-[150px] 2xl:w-[180px] py-5 flex items-center justify-center mx-4"
              >
                <Image src={B3} alt="hero-image" className="w-full h-10" />
              </a>
              <a
                href="#"
                className="w-[150px] 2xl:w-[180px] py-5 flex items-center justify-center mx-4"
              >
                <Image src={B4} alt="hero-image" className="w-full h-10" />
              </a>
            </div>
          </div>
        </div>
