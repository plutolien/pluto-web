  ...
  return (
    ...
    <section className="bg-white dark:bg-gray-900">
        <div className="container flex flex-col items-center px-4 py-[80px] mx-auto text-center">
            ...
            <p className="block max-w-2xl mt-4 text-xl text-gray-500 dark:text-gray-300">We can help you bring success to your business – whether it’s IT consultancy, full-cycle software development, or set up a dedicated developers team.</p>
