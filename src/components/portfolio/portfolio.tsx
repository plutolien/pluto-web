        ...
        <div className="container grid max-w-screen-xl gap-8 lg:grid-cols-2 lg:grid-rows-2">
          <div className="row-span-2 flex flex-col rounded-md border border-slate-200">
            ...
            <div className="p-10">
              ...
              <p className="mt-2 text-slate-500">
                ...
                can be successfully applied to other businesses, as well as used
          ...
          <div className="flex rounded-md border border-slate-200">
            <div className="flex-1 p-10">
              ...
              <p className="mt-2 text-slate-500">
                Pluto Chat allows you to create chat and discussion platforms.
                You can create chat groups with other people, send and receive
                private messages and various digital documents (video, photos,
                files, audio). Compatible with all devices. We have components
          ...
          <div className="flex rounded-md border border-slate-200">
            <div className="flex-1 p-10">
              ...
              <p className="mt-2 text-slate-500">
                Pluto Pharma comes with a great selection of layouts for every
                modern drugstore, medical store, apothecary, vitamin and
                supplements store & supplement products website
              </p>
              <a href="" className="mt-2 inline-flex text-sky-500">
                Read More →
              </a>
